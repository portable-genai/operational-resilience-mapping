# Operational Resilience Studio (operational-resilience-mapping) serving image.
#
...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    RESILIENCE_PROFILE=gcp \
    RESILIENCE_SETTINGS=/app/config/settings.yaml \
    PORT=8080
...
CMD ["sh", "-c", "python -m operational_resilience_mapping.managed_readiness && exec uvicorn operational_resilience_mapping.api.app:app --host 0.0.0.0 --port ${PORT:-8080}"]
