...
Cribbed from Rsk3's ``IaCScannerPort``: ``scan(target)`` over a project / folder / org scope
returns normalised resource configs (the technology chain). The offline family returns a
