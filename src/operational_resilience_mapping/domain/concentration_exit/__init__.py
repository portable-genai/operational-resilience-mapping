...
``architecture_validator``'s ``domain/residency/``: it reuses Rgc9's shared kernel types
(``Citation``, ``Severity``, ``utcnow``, ``SEVERITY_RANK``) and keeps only the
...
findings are unchanged. In Rgc9 the concentration
