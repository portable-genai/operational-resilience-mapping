# SPEC: Operational Resilience Studio (`operational-resilience-mapping`)
...
- `pii_safety >= 0.99` (pack scan + pack-independent planted-literal check), over BOTH boundaries
  the studio crosses: the model prompt and the WORM record's content fields
