# ARCHITECTURE: Operational Resilience Studio (`operational-resilience-mapping`)

Hexagonal ports-and-adapters. A pure-stdlib domain core speaks only to ports (`typing.Protocol`s);
adapter families implement them; one env var (`RESILIENCE_PROFILE`) swaps the
...
## Layout (`src/operational_resilience_mapping/`)
