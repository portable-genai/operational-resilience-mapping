...
read
    ...
    bind_profile == local AND profile chosen AND RESILIENCE_S2S_TOKEN unset
...
from operational_resilience_mapping.adapters.local.identity import (
    LocalIdentityAdapter,
)
from operational_resilience_mapping.adapters.onprem.identity import (
