...
def test_the_demo_data_is_obviously_fictional() -> None:
    for service in (demo.SERVICE, demo.PII_SERVICE):
        assert "FICTIONAL" in service.name, service.name + " does not announce itself as fake"
    blob = demo.FICTIONAL_BLOB + " " + demo.ACTOR
